<template>
  <svg v-if="animate" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"
       xmlns:xlink="http://www.w3.org/1999/xlink">
    <defs>
      <linearGradient id="a" gradientUnits="userSpaceOnUse" x1="150" x2="234" y1="119.2" y2="264.8">
        <stop offset="0" stop-color="#fbbf24"/>
        <stop offset=".5" stop-color="#fbbf24"/>
        <stop offset="1" stop-color="#f59e0b"/>
      </linearGradient>
      <clipPath id="b">
        <path d="M0 0h512v306H0z" fill="none"/>
      </clipPath>
      <symbol id="c" viewBox="0 0 384 384">
        <circle cx="192" cy="192" fill="url(#a)" r="84" stroke="#f8af18" stroke-miterlimit="10"
                stroke-width="6"/>
        <path
  ...
  <svg v-else viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <defs>
      <linearGradient id="a" gradientUnits="userSpaceOnUse" x1="149.99" x2="234.01" y1="119.24" y2="264.76">
        <stop offset="0" stop-color="#fbbf24"/>
        <stop offset="0.45" stop-color="#fbbf24"/>
        <stop offset="1" stop-color="#f59e0b"/>
      </linearGradient>
      <clipPath id="b">
        <rect fill="none" height="306" width="512"/>
      </clipPath>
      <symbol id="c" viewBox="0 0 384 384">
        <circle cx="192" cy="192" fill="url(#a)" r="84" stroke="#f8af18" stroke-miterlimit="10" stroke-width="6"/>
        <path
    ...
    <line fill="none" stroke="#FFFFFF" stroke-linecap="round" stroke-linejoin="round" stroke-width="18" x1="110"
          x2="400"
          y1="332" y2="332"/>
  </svg>
